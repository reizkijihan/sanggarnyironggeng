...
<body>
  <div id="wrapper">
    <nav class="navbar sticky-top navbar-expand-lg navbar-light" role="navigation">
      <a class="navbar-brand" href="index.php?page=home"><img src="admin/logo.png"  width="90"></a></a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="index.php?page=galeri">Galeri<span class="sr-only">(current)</span></a>
          </li>
          ...
          <li class="nav-item active">
            <a class="nav-link" href="index.php?page=bantuan">Bantuan<span class="sr-only">(current)</span></a>
          </li>
           <li class="nav-item active">
            <a class="nav-link" href="index.php?page=registrasi">Regist/Login<span class="sr-only">(current)</span></a>
          </li>
              </ul>
            </li>
          </ul>
